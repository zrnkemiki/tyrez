...
const tyreCatalog = {
  Michelin: ["Pilot Sport 3", "Pilot Sport 4", "Pilot Sport 5", "Primacy HP", "Primacy 3", "Primacy 4+", "Energy Saver", "Energy Saver+", "Alpin A4", "Alpin 5", "Alpin 6", "CrossClimate", "CrossClimate 2", "Latitude Tour HP", "Agilis+"],
  Continental: ["ContiPremiumContact 5", "ContiPremiumContact 6", "PremiumContact 7", "ContiSportContact 5", "ContiSportContact 6", "ContiEcoContact 5", "EcoContact 6", "WinterContact TS 850", "WinterContact TS 860", "WinterContact TS 870", "AllSeasonContact", "AllSeasonContact 2", "VancoContact 2"],
  Goodyear: ["EfficientGrip", "EfficientGrip Performance", "EfficientGrip Performance 2", "Excellence", "Eagle F1 Asymmetric 2", "Eagle F1 Asymmetric 3", "Eagle F1 Asymmetric 5", "Eagle F1 Asymmetric 6", "UltraGrip 8", "UltraGrip 9", "UltraGrip Performance Gen-1", "UltraGrip Performance+", "Vector 4Seasons", "Vector 4Seasons Gen-2", "Vector 4Seasons Gen-3", "Cargo Vector"],
  Pirelli: ["P Zero", "P Zero Nero", "Cinturato P1 Verde", "Cinturato P6", "Cinturato P7", "Cinturato P7 Blue", "Cinturato All Season", "Cinturato All Season SF 2", "Cinturato All Season SF 3", "Sottozero 3", "Winter Sottozero 3", "Scorpion Verde", "Carrier"],
  Bridgestone: ["Turanza ER300", "Turanza T001", "Turanza T005", "Potenza RE050A", "Potenza S001", "Potenza Sport", "Blizzak LM001", "Blizzak LM005", "Weather Control A005", "Dueler H/P Sport", "Duravis R660"],
  Dunlop: ["SP Sport 01", "SP Sport FastResponse", "Sport BluResponse", "Sport Maxx RT", "SP Sport Maxx", "Winter Response 2", "Winter Sport 5", "Grandtrek AT5"],
  Hankook: ["Kinergy Eco K425", "Kinergy 4S2", "Ventus Prime 2", "Ventus Prime 3", "Ventus Prime 4", "Ventus S1 evo2", "Ventus S1 evo3", "Winter i*cept RS2", "Winter i*cept RS3", "Vantra LT"],
  Kumho: ["Ecsta KU31", "Ecsta HS51", "Ecsta HS52", "Solus KH17", "Solus 4S HA32", "WinterCraft WP51", "WinterCraft WP52", "Crugen HP91"],
  Nexen: ["N Blue HD", "N Blue HD Plus", "N Blue 4Season", "N Blue 4Season 2", "N Fera SU1", "N Fera Sport", "Winguard Snow G", "Winguard Sport", "Winguard Sport 2", "Roadian HTX"],
  Tigar: ["Prima", "Sigura", "High Performance", "UHP", "Wintera", "Winter 1", "Touring"],
  Sava: ["Intensa HP", "Intensa HP2", "Intensa UHP", "Eskimo S3+", "Eskimo HP", "Eskimo HP2", "All Weather"],
  Barum: ["Bravuris 3HM", "Bravuris 5HM", "Brillantis 2", "Polaris 3", "Polaris 5", "Quartaris 5"],
  Firestone: ["Multihawk 2", "Roadhawk", "Winterhawk 3", "Winterhawk 4", "Destination HP"],
  Uniroyal: ["RainSport 3", "RainSport 5", "RainExpert 3", "MS Plus 77", "AllSeasonExpert 2"],
  Kleber: ["Dynaxer HP3", "Dynaxer UHP", "Krisalp HP3", "Quadraxer 2", "Transpro 4S"],
  BFGoodrich: ["g-Grip", "Advantage", "All-Terrain T/A KO2", "Winter T/A KSI"],
  Fulda: ["EcoControl HP", "SportControl 2", "Kristall Control HP2", "Multicontrol"],
  Toyo: ["Proxes T1 Sport", "Proxes CF2", "Celsius", "Observe GSi-6"],
  Vredestein: ["Sportrac 5", "Ultrac Satin", "Quatrac 5", "Wintrac Pro"],
  Matador: ["MP47 Hectorra 3", "MP92 Sibir Snow", "MP62 All Weather Evo"],
  Debica: ["Presto HP2", "Frigo HP2", "Navigator 3"],
  Lassa: ["Driveways", "Snoways 3", "Multiways 2"],
};
